# Format text in Facebook chat messages on a computer
...
| **Codeblock**  | `Text` | ```<br>```a</br>```s ``` | | 1. Type three backticks<br>2. Type one line break (press **Shift** + **Return**)<br>3. Type your text<br>4. Type another line break (press **Shift** + **Return**)<br>5. Type three more backticks |
